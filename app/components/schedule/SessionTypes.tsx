  ...
  const sessionOptions = [
    {
      ...
      duration: '30 minutes',
      price: 150,
      description: 'Perfect for getting clear guidance on one specific area. Great for first-time clients or when you have a focused question.',
      icon: '🌸',
      popular: false,
    ...
    },
    {
      ...
      duration: '90 minutes',
      price: 250,
      description: 'Perfect for the full spiritual overview or complex life situations. Maximum time for transformation and understanding.',
      icon: '✨',
      popular: false,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Simple, transparent pricing based on time. We'll customize the content to what you need most.
          </p>
        </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {serviceCategories.map((category, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className={`w-12 h-12 bg-gradient-to-br ${category.color} rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}>
        ...
        >
          ...
          <div className="grid md:grid-cols-4 gap-6 text-center">
            {[
              ...
              { number: '3', title: 'Share Focus', desc: 'Tell us what you\'d like to explore' },
              { number: '4', title: 'Receive Guidance', desc: 'Experience your transformation' }
            ].map((step, index) => (
