...
Patterns don't exist in isolation. They're attached to identities.

The rescuer pattern belongs to the rescuer identity. The performer pattern belongs to the performer identity. The good one pattern belongs to the good one identity.

**You don't just heal patterns. You outgrow the identities they're attached to.**

That's what's been happening throughout this work. And now it's time to make it conscious.

---

## Field Note (Before): The Good One

She's always been the good one.

The one who accommodates. Who smooths things over. Who makes others comfortable.
...
## Field Note (After): The One Who Chooses

She's still kind. Still caring. Still thoughtful.
...
Even after you've done the work, identity residues remain.

These are the old roles that:
- Feel like home (even when they hurt)
...
## Why the Brain Returns to Old Defaults Under Stress

You've done the work. You're different now.

Then stress hits—and there you are again. Rescuing. Performing. Shrinking.

**Why?**

The brain is designed for efficiency. Under stress, it routes to the fastest, most practiced path.

Old identities are practiced. They run automatically. They don't require conscious choice.

**New identities are still being built.** They require more bandwidth. Under stress, there isn't enough bandwidth—so the brain defaults.
...
## Neuroscience Lens: Identity and Neural Pathways

Your sense of identity is stored in neural networks.
...
## The "I Am No Longer Available For..." Practice

A declarative practice for releasing old identities.
...
## Identity Rewrite: Before and After
...
## How to Know the New Identity Is Taking Hold
...
## When Old Identities Try to Return
...
## A Practice: Weekly Identity Review

Once a week, check in with the transition:
...
- What old identity am I still carrying?
...
> *"I don't heal a pattern. I graduate from an identity. The old role is not who I am—it's who I was trained to be."*
