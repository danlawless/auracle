...
export const volumes: Volume[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { slug: 'appendix-session-hygiene', title: 'Appendix A: Session Hygiene Checklist', filename: 'appendix-a-session-hygiene-checklist.md', type: 'appendix' },
      { slug: 'appendix-red-flags-client', title: 'Appendix B: Red Flags in Client Relationships', filename: 'appendix-b-red-flags-client-relationships.md', type: 'appendix' },
      { slug: 'appendix-helping-or-hiding', title: 'Appendix C: Self-Assessment: Helping or Hiding?', filename: 'appendix-c-self-assessment-helping-or-hiding.md', type: 'appendix' },
      { slug: 'appendix-referral-scripts', title: 'Appendix D: Referral Resources & Scripts', filename: 'appendix-d-referral-resources-scripts.md', type: 'appendix' },
      { slug: 'appendix-decoder-cards-guides', title: 'Appendix E: Decoder Cards for Guides', filename: 'appendix-e-decoder-cards-guides.md', type: 'appendix' },
    ],
  },
  {
    id: 'vol-7-return',
  ...
  },
  {
    ...
    chapters: [
      ...
      { slug: 'appendix-quantum-inventory', title: 'Appendix A: The Quantum Inventory', filename: 'appendix-a-quantum-inventory.md', type: 'appendix' },
      { slug: 'appendix-daily-practices', title: 'Appendix B: Daily Quantum Practices', filename: 'appendix-b-daily-practices.md', type: 'appendix' },
      { slug: 'appendix-synchronicity-journal', title: 'Appendix C: The Synchronicity Journal', filename: 'appendix-c-synchronicity-journal.md', type: 'appendix' },
      { slug: 'appendix-emergence-signs', title: 'Appendix D: Signs of Quantum Emergence', filename: 'appendix-d-emergence-signs.md', type: 'appendix' },
      { slug: 'appendix-resources', title: 'Appendix E: Resources for Continued Awakening', filename: 'appendix-e-resources.md', type: 'appendix' },
    ],
  },
];
