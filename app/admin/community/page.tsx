...
export default function CommunityHubPage() {
  const [activeTab, setActiveTab] = useState<
    'students' | 'achievements' | 'communications' | 'insights'
  >('students');
  ...
  const achievements = [
    {
      name: 'First Lesson',
      description: 'Completed their first lesson',
      icon: '🌱',
      rarity: 'common',
      earned: 342,
    },
    {
      name: '7-Day Streak',
      description: 'Maintained 7 consecutive days',
      icon: '🔥',
      rarity: 'uncommon',
      earned: 89,
    },
        ...
        >
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Nurture and support your sacred learning community
            </p>
          </div>

          <SacredButton variant="sacred" icon={Send} sacred>
            Send Announcement
          </SacredButton>
        </motion.div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`p-3 rounded-xl bg-gradient-to-br ${
                      stat.color === 'rose'
                        ? 'from-rose-pink to-deep-rose'
                        : stat.color === 'golden'
                          ? 'from-golden-light to-yellow-400'
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Recognize and celebrate your students&apos; spiritual journey
                    milestones
                  </p>
                </div>
            ...
            {activeTab === 'communications' && (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Send announcements and messages to your sacred community
                  </p>
                </div>
                      ...
                      <SacredSelect
                        ...
                        options={[
                          ...
                          { value: 'active', label: 'Active Students Only' },
                          {
                            ...
                            label: 'Specific Course Students',
                          },
                        ]}
                        value="all"
                        onChange={() => {}}
                        ...
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                              Announced Advanced Chakra Healing course
                            </p>
                            <p className="text-xs text-gray-500 mt-2">
                              Sent to 342 students • March 10
                            </p>
                          </div>
                      ...
                      <div className="p-3 bg-golden-50 rounded-xl">
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                              Gentle reminder for practice consistency
                            </p>
                            <p className="text-xs text-gray-500 mt-2">
                              Sent to 89 active students • March 8
                            </p>
                          </div>
                          <span className="text-green-600 text-sm">Delivered</span>
                        </div>
            ...
            {activeTab === 'insights' && (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Understand your community&apos;s growth and engagement patterns
                  </p>
                </div>
