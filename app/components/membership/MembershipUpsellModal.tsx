        ...
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              Enhance your {courseTitle} experience with live guidance and community
              support
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="text-sm text-amber-800">
                ...
                <ul className="space-y-1">
                  <li>
                    • This community membership offer is only available during your
