...
This chapter maps the terrain. By understanding the different types, you'll be equipped to recognize narcissistic patterns regardless of the costume they wear.

---

## The Spectrum of Narcissism

Before we dive into types, let's acknowledge: narcissism exists on a spectrum.
...
Moving along the spectrum, we encounter **narcissistic traits**—behaviors that most people exhibit sometimes, especially under stress. Occasionally being self-centered or seeking validation doesn't make someone a narcissist.
...
What we're concerned with in this book isn't diagnosis. We're concerned with **patterns of behavior that cause harm**—wherever they fall on the spectrum.
...
- Additional types (Malignant, Cerebral, Somatic, Histrionic) focus their superiority in specific domains
...
**What's Next:**
Understanding types gives you the foundation. But narcissists don't just have types—they play roles. In the next chapter, we'll explore the specific identity masks they adopt to control situations and avoid accountability. These roles shift and change, and recognizing them is essential for seeing through the performance.
