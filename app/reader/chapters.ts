...
export const volumes: Volume[] = [
  {
    ...
    chapters: [
      ...
      { slug: 'family-systems', title: 'Family Systems & Narcissistic Dynamics', filename: '06-family-systems.md', type: 'chapter' },
      { slug: 'manipulation-in-relationships', title: 'Recognizing Manipulation in Different Relationships', filename: '07-manipulation-in-relationships.md', type: 'chapter' },
      { slug: 'decoder-cards', title: 'Decoder Cards', filename: '08-decoder-cards.md', type: 'chapter' },
      { slug: 'energetic-remapping', title: 'Energetic Remapping — Recovery Tools', filename: '09-energetic-remapping.md', type: 'chapter' },
      { slug: 'practical-responses', title: 'Practical Responses & Scripts', filename: '10-practical-responses.md', type: 'chapter' },
      { slug: 'moving-forward', title: 'Moving Forward', filename: '11-moving-forward.md', type: 'chapter' },
